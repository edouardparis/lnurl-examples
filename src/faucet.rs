...
pub struct Faucet {
    ...
    pub amount_max_withdrawable: AtomicUsize,
    pub amount_min_withdrawable: AtomicUsize,
    pub lnurl: String,
    pub callback: String,
    pub client: Client,
    pub qrcode: Vec<u8>,
...
impl Faucet {
    pub fn new(url: &str, callback: &str, clt: Client, remain_counter: AtomicUsize) -> Faucet {
        ...
        Faucet {
            amount_max_withdrawable: AtomicUsize::new(1000),
            amount_min_withdrawable: AtomicUsize::new(10),
            qrcode: image,
